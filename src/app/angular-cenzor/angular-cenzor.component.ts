...
@Component({
  selector: 'app-angular-cenzor',
  templateUrl: './angular-cenzor.component.html',
  styleUrls: ['./angular-cenzor.component.scss']
})

export class AngularCenzorComponent implements OnInit {
